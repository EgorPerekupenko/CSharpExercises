...
namespace CSharpExercises
{
    public static class Exercises
    {
        ...
        public static decimal Divide(decimal firstNumber, decimal secondNumber)
        {
            firstNumber = 10;
            secondNumber = 5;
            decimal  Divide = firstNumber / secondNumber;
            return Divide;
        }
        ...
        public static string ReverseStringHard(string String)
        {
      ...
      public  static double ConvertKelvinToFahrenheit(double f )
        {

            double Fahrenheit = Math.Round((9.0 / 5) * (f - 273.15) + 32, 2);
        ...
        public static double GetAverageHard(   int [] myArr)
        {
            double[] array1 = { 10, 20, 30, 40, 50, 60, 80 };
        ...
        // public static double  GetAveregeEasy( int[] myarr)
        // {
        //   int sum = Sum(myarr);
        // double result = (double)sum / myarr.Length;
        // return result;
        //}
